...
1. **Fork and clone the repository**
   ```bash
   git clone https://github.com/YOUR_USERNAME/dupster.git
   cd dupster
   ```
...
Feel free to open a discussion in [GitHub Discussions](https://github.com/karimz1/dupster/discussions) or reach out to the maintainer.
